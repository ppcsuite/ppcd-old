...
func NewGetKernelStakeModifierCmd(hash string, verbose *bool) (*GetKernelStakeModifierCmd, error) {
...
func NewGetNextRequiredTargetCmd(proofOfStake *bool, verbose *bool) (*GetNextRequiredTargetCmd, error) {
...
func NewFindStakeCmd(maxTime int64, difficulty float64, verbose *bool) (*FindStakeCmd, error) {
	return &FindStakeCmd{
		MaxTime:    maxTime,
