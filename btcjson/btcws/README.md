...
[![Build Status](https://travis-ci.org/ppcsuite/ppcd/btcjson/btcws.png?branch=master)]
(https://travis-ci.org/ppcsuite/ppcd/btcjson/btcws)
...
```bash
$ go get github.com/ppcsuite/ppcd/btcjson/btcws
```
