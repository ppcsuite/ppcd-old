...
func WriteMessageN(w io.Writer, msg Message, pver uint32, chaincfg BitcoinNet) (int, error) {
	totalBytes := 0
...
func WriteMessage(w io.Writer, msg Message, pver uint32, chaincfg BitcoinNet) error {
	_, err := WriteMessageN(w, msg, pver, chaincfg)
	return err
}
...
func ReadMessageN(r io.Reader, pver uint32, chaincfg BitcoinNet) (int, Message, []byte, error) {
	totalBytes := 0
