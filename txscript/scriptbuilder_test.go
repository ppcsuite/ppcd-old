...
func TestScriptBuilderAddData(t *testing.T) {
	tests := []struct {
		...
		{name: "push small int 0", data: []byte{0}, expected: []byte{txscript.OP_0}},
		{name: "push small int 1", data: []byte{1}, expected: []byte{txscript.OP_1}},
		{name: "push small int 2", data: []byte{2}, expected: []byte{txscript.OP_2}},
		{name: "push small int 3", data: []byte{3}, expected: []byte{txscript.OP_3}},
		{name: "push small int 4", data: []byte{4}, expected: []byte{txscript.OP_4}},
		{name: "push small int 5", data: []byte{5}, expected: []byte{txscript.OP_5}},
		{name: "push small int 6", data: []byte{6}, expected: []byte{txscript.OP_6}},
		{name: "push small int 7", data: []byte{7}, expected: []byte{txscript.OP_7}},
		{name: "push small int 8", data: []byte{8}, expected: []byte{txscript.OP_8}},
		{name: "push small int 9", data: []byte{9}, expected: []byte{txscript.OP_9}},
		{name: "push small int 10", data: []byte{10}, expected: []byte{txscript.OP_10}},
		{name: "push small int 11", data: []byte{11}, expected: []byte{txscript.OP_11}},
		{name: "push small int 12", data: []byte{12}, expected: []byte{txscript.OP_12}},
		{name: "push small int 13", data: []byte{13}, expected: []byte{txscript.OP_13}},
		{name: "push small int 14", data: []byte{14}, expected: []byte{txscript.OP_14}},
		{name: "push small int 15", data: []byte{15}, expected: []byte{txscript.OP_15}},
		{name: "push small int 16", data: []byte{16}, expected: []byte{txscript.OP_16}},
